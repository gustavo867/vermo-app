...
export default function ResetPassword({ navigation }) {
  return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}>Please enter your new password and confirm the password.</Text>
        ...
        <View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Login')} style={styles.submitContainer}>
